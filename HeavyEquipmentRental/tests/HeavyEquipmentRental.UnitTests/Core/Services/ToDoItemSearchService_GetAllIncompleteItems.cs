...
using HeavyEquipmentRental.Core.ProjectAggregate;
using HeavyEquipmentRental.Core.Services;
using HeavyEquipmentRental.SharedKernel.Interfaces;
using Moq;
using Xunit;

namespace HeavyEquipmentRental.UnitTests.Core.Services
{
