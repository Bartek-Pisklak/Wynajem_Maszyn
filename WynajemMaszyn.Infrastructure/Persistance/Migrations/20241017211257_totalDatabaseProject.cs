...
namespace WynajemMaszyn.Infrastructure.Persistance.Migrations
{
    ...
    public partial class totalDatabaseProject : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "integer", nullable: false)
                        .Annotation("Npgsql:ValueGenerationStrategy", NpgsqlValueGenerationStrategy.IdentityByDefaultColumn),
                    Name = table.Column<string>(type: "text", nullable: false),
                    IdExcavator = table.Column<int>(type: "integer", nullable: false),
                    IdExcavatorBucket = table.Column<int>(type: "integer", nullable: false),
                    IdRoller = table.Column<int>(type: "integer", nullable: false),
                    IdHarvester = table.Column<int>(type: "integer", nullable: false),
                    IdWoodChipper = table.Column<int>(type: "integer", nullable: false),
            ...
            migrationBuilder.CreateTable(
                name: "MachineryRentalMachines",
                columns: table => new
                {
                    MachineryRentalsId = table.Column<int>(type: "integer", nullable: false),
                    MachinesId = table.Column<int>(type: "integer", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_MachineryRentalMachines", x => new { x.MachineryRentalsId, x.MachinesId });
                    table.ForeignKey(
                        name: "FK_MachineryRentalMachines_Machiners_MachinesId",
                        column: x => x.MachinesId,
                        principalTable: "Machiners",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_MachineryRentalMachines_MachineryRentals_MachineryRentalsId",
                        column: x => x.MachineryRentalsId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_MachineryRentalMachines_MachinesId",
                table: "MachineryRentalMachines",
                column: "MachinesId");
